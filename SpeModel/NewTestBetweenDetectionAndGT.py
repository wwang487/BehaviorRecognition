...
def generate_empty_dict(res_dict, GT_dict):
...
def parse_args():
    ...
    parser.add_argument('--boxfolder', dest='boxfolder',
                          ...
                          default='./Accuracy_Test/boxes/Imgs/', type=str)
    ...
    parser.add_argument('--picklesavedir', dest='picklesavedir',
                          ...
                          default="Accuracy_Test/pickle/")
    parser.add_argument('--csvsavedir', dest='csvsavedir',
                          help='directory to save csv files',
                          default="./Accuracy_Test/tables/")
...
if __name__ == "__main__":
    ...
    iou_thresh, bound_thresh, overlap_thresh, p_thresh = args.iouthresh, args.pthresh, args.boundthresh, args.overlapthresh
