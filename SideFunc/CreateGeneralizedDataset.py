...
def copy_xml_data(orig_xml_file, orig_xml_path, new_xml_path, new_spe_tag, name_choice):
...
def parse_args():
    ...
    parser.add_argument('--old_spe_xml_path', dest='roedeer_spe_xml_path',
                      help='directory to roedeer spe xml files',
                      default= "/media/wlp/My Book/Africa_data/xml_spe/")
    parser.add_argument('--old_head_xml_path', dest='roedeer_head_xml_path',
                      help='directory to roedeer head xml files',
                      default= "/media/wlp/My Book/Africa_data/xml_head/")
    parser.add_argument('--old_img_path', dest='roedeer_img_path',
                      help='directory to roedeer img files',
                      default= "/media/wlp/My Book/Africa_data/img/")

    parser.add_argument('--out_path', dest='out_path',
                      help='directory to save merged dataset',
                      default= "/media/wlp/My Book/MergedDataSet/ENO/")
...
if __name__ == '__main__':
    ...
    for r in roedeer_to_test:
        ...
        copy_xml_data(temp_xml, roedeer_spe_xml_path, out_spe_path, 'deer', False)
        copy_xml_data(temp_xml, roedeer_head_xml_path, out_head_path, '', False)
